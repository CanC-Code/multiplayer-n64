...
#include "custom/save_memory_compat.h"
#include "custom/path_compat.h"
        ...
        /* otherwise let the core do the processing */
            ...
            for(k = 0; k < PAK_MAX_SIZE; ++k) {
                ...
                /* Memory Pak */
                    ...
                    /* Initialize persistent memory (EEPROM, SRAM, FlashRAM, Mempak) */
                        saved_memory_init();
                            saved_memory_load_all();
